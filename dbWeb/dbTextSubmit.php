<!-- db.php
     A PHP script to access the Deck Builder database
     through MySQL
     -->
<html>
<head>
...
// INSERT INTO UserD VALUES ('$input1', "$input2", '$input3' \$UserID)
$query = "INSERT INTO UserD VALUES ($UserID, '$Email', '$DoB')";
